...
const Header = () => {
  ...
  const isValidAvatar = (avatar) => {
    return avatar && avatar !== 'default.jpg' && avatar !== 'null' && avatar !== '';
  };
      ...
      <div className="flex items-center gap-4 relative z-50">
        {isLogin ? (
          <>
            ...
            >
              {currentUser?.avatar && isValidAvatar(currentUser.avatar) ? (
                <div className="w-8 h-8 rounded-full overflow-hidden border-2 border-white/30 bg-white/20 flex items-center justify-center">
                  <img 
                  ...
                  />
                  <FaRegUser className="text-white text-sm hidden" />
                </div>
              ) : (
